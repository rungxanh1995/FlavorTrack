...
final class BusinessCell: UICollectionViewCell {
	...
	private func configure() -> Void {
		...
		NSLayoutConstraint.activate([
			...
			businessNameLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: padding),
			businessNameLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -(padding)),
