...
final class SearchVC: UIViewController {
	...
	override func viewDidLoad() {
		...
		view.addAllSubviewsAndDisableAutoConstraints(logoImageView, locationTextField,
													 businessTypeTextField, callToActionButton)
...
private extension SearchVC {
	...
	private func configKeyboardHiding() {
	...
	private func configDismissKeyboardTapGesture() {
